...
public class Ex10Argument {
	...
	public static void main(String[] args) {
        ...
        //3과목의 점수를 double로 읽어서 총점과 평균 구하기
        ...
        System.out.printf("점수 1 : %3.1f점\n", score1);
        System.out.printf("점수 2 : %3.1f점\n", score2);
        System.out.printf("점수 3 : %3.1f점\n", score3);
        System.out.printf("총 점 : %3.1f점\n", total);
        System.out.printf("평 균 : %3.1f점\n", average);
